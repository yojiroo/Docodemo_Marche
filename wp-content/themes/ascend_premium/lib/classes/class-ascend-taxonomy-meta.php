...
class Ascend_Taxonomy_Meta {
	...
	function admin_enqueue_scripts()
	{
		...
		wp_enqueue_media();
		wp_register_script('kad_term_js', get_template_directory_uri() . '/assets/js/min/ascend-terms-min.js', false, ASCEND_VERSION, false);
	...
	function show_field_file( $field, $meta ) {
		...
		echo "<a href='#' class='rwtm-file-upload button' data-field='{$field['id']}'>" . __( 'Select File', 'ascend' ) . "</a>";
		echo '</td>';
	}
	...
	function show_field_image( $field, $meta ) {
		...
		echo "<a href='#' class='rwtm-image-upload button' data-field='{$field['id']}'>" . __( 'Select Image', 'ascend' ) . "</a>";
		echo '</td>';
	}
