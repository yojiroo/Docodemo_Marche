...
class Ascend_custom_menu {
  ...
  */
  public function ascend_add_nav_fields( $menu_item ) {
      ...
      $menu_item->kthide_label = get_post_meta( $menu_item->ID, '_menu_item_kthide_label', true );
  ...
  */
  public function ascend_custom_nav_fields( $item_id, $item, $depth, $args ) {
    ...
    ?>
              ...
              <p class="field-kthide_label description description-thin" style="margin-top: 25px;">
                 <label for="edit-menu-item-kthide_label-<?php echo esc_attr($item_id); ?>">
                   <input type="checkbox" id="edit-menu-item-kthide_label-<?php echo esc_attr($item_id); ?>" value="enabled" name="menu-item-kthide_label[<?php echo esc_attr($item_id); ?>]"  <?php checked( $item->kthide_label, 'enabled' ); ?>  />
                    <?php _e( 'Hide Menu Label', 'ascend' ); ?>
                </label>
              </p>
    <?php
  }
  ...
  */
  function ascend_update_nav_fields( $menu_id, $menu_item_db_id, $args ) {
        ...
        if( isset( $_REQUEST['menu-item-kthide_label'][$menu_item_db_id] ) ) {
          	$valuelabel = sanitize_title(wp_unslash($_REQUEST['menu-item-kthide_label'][$menu_item_db_id]));
          	update_post_meta( $menu_item_db_id, '_menu_item_kthide_label', $valuelabel);
        } else {
        	delete_post_meta($menu_item_db_id, '_menu_item_kthide_label');
        }
  }
