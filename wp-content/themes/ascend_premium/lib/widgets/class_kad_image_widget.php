...
class kad_image_widget extends WP_Widget{
    ...
    public function widget($args, $instance){ 
        ...
        echo $before_widget; 
            echo '<div class="kad_img_upload_widget kt-shape-type-'.esc_attr($shape).' '.esc_attr($align).' kt-image-widget-'.esc_attr($args['widget_id']).'">';
				if( 'standard' != $instance['image_shape'] ) {
                ...
                if($uselink == true) {
               	...
               	if(!empty($instance['text'])) {
               		echo '<div class="kadence_image_widget_caption">'.wp_kses_post($instance['text']).'</div>';
               	}
               	if( 'standard' != $instance['image_shape'] ) {
              		echo '</div>';
              	}
  ...
  public function form($instance){ 
    ...
    $shadow_options = array("none" => __('None', 'ascend'), "small" => __('Small', 'ascend'), "medium" => __('Medium', 'ascend'), "large" => __('Large', 'ascend'), "small_below" => __('Small Below', 'ascend'), "medium_below" => __('Medium Below', 'ascend'), "large_below" => __('Large Below', 'ascend'));
    $shape_options = array("standard" => __('Standard', 'ascend'), "square" => __('Square', 'ascend'), "circle" => __('Circle', 'ascend'), "diamond" => __('Diamond', 'ascend'), "hexagon" => __('Hexagon', 'ascend'), "octogon" => __('Octogon', 'ascend'));
    $align_options = array("center" => __('Center', 'ascend'), "left" => __('Left', 'ascend'), "right" => __('Right', 'ascend'));
  ...
  <div class="kad_img_upload_widget">
    ...
    <p>
     ...
     <p>
        <label for="<?php echo $this->get_field_id('align'); ?>"><?php _e('Align Image', 'ascend'); ?></label><br />
    ...
    <p>
        <label for="<?php echo $this->get_field_id('image_shape'); ?>"><?php _e('Image Shape', 'ascend'); ?></label><br />
    ...
    <p>
        <label for="<?php echo $this->get_field_id('box_shadow'); ?>"><?php _e('Image Shadow (only works with basic shapes)', 'ascend'); ?></label><br />
