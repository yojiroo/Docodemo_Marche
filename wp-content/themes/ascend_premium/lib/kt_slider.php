...
if(!function_exists('ascend_build_slider_home')) {
    function ascend_build_slider_home($slides = null, $width = null, $height = null, $class = null, $id = 'kt_slider_options', $type = 'slider', $captions = "false", $auto = 'true', $speed = '7000', $arrows = 'true', $fade = 'true', $fade_speed = '400', $title_max = '70', $title_min = '40', $subtitle_max = '30', $subtitle_min = '20', $align = 'center') {
        ...
        if(!empty($slides)) :
        	$items = count($slides);
            echo '<div id="'.esc_attr($id).'" class="slick-slider kad-light-gallery kt-slickslider titleclass loading '.esc_attr($class).'" data-slider-speed="'.esc_attr($speed).'" data-slider-anim-speed="'.esc_attr($fade_speed).'" data-slider-fade="'.esc_attr($fade).'" data-slider-type="'.esc_attr($stype).'" data-slider-auto="'.esc_attr($auto).'" data-slider-thumbid="#'.esc_attr($id).'-thumbs" data-slides-to-show="'.esc_attr($items - 1).'" data-slider-arrows="'.esc_attr($arrows).'" data-slider-thumbs-showing="'.esc_attr($thumbs_showing).'" style="max-width:'.esc_attr($width).'px;">';
...
if(!function_exists('ascend_build_slider')) {
    function ascend_build_slider($id = 'post', $images = null, $width = null, $height = null, $link ='image', $class = null, $type = 'slider', $captions = "false", $auto = 'true', $speed = '7000', $arrows = 'true', $fade = 'true', $fade_speed = '400', $delay = '0') {
        ...
        if(!empty($images)) :
            ...
            echo '<div id="kt_slider_'.esc_attr($id).'" class="slick-slider kad-light-gallery kt-slickslider loading '.esc_attr($class).'" data-slider-speed="'.esc_attr($speed).'" data-slider-anim-speed="'.esc_attr($fade_speed).'" data-slider-fade="'.esc_attr($fade).'" data-slider-type="'.esc_attr($type).'" data-slider-auto="'.esc_attr($auto).'" data-slider-thumbid="#kt_slider_'.esc_attr($id).'-thumbs" data-slider-arrows="'.esc_attr($arrows).'" data-slider-initdelay="'.esc_attr($delay).'" data-slides-to-show="'.esc_attr($show_slides).'" data-slider-thumbs-showing="'.esc_attr(ceil($thumb_overview_width/80)).'" style="max-width:'.esc_attr($width).'px;">';
                    if ($attachments) {
                        foreach ($attachments as $attachment) {
                            ...
                            echo '<div class="kt-slick-slide">';
                                if($link == "post") {
                                    ...
                                    echo '<div class="kt-slider-image-link kt-slider-no-link">';
                                } else {
