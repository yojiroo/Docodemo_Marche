<?php
	...
	if(!empty($sub_color) && $sub_color != '#') {
		$scolor = 'color:'.$sub_color.';';
	} else {
		$scolor = '';
	}
		...
		<div class="container">
			<div class="page-header" style="<?php echo esc_attr($talign);?>">
				<div class="page-header-inner">
					...
					echo '<'.esc_attr( $title_tag ).' style="'.esc_attr( $tcolor ).'" class="page_head_title top-contain-title entry-title" itemprop="name" data-max-size="'.esc_attr( $title_data ).'" data-min-size="'.esc_attr( $title_small_data ).'">'. apply_filters('kadence_page_title', ascend_title() ).' </'.esc_attr( $title_tag ).'>';
