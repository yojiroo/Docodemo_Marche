...
$ascend_code = 'not-active';
if ( get_option( 'kt_api_manager_ascend_premium_activated' ) == 'Activated' ) {
    $ascend_code = 'kt-ascend-key';
    $Ascend_UpdateChecker = new ThemeUpdateChecker('ascend_premium', 'https://kernl.us/api/v1/theme-updates/5892400bd253d976c4380efd/');
	$Ascend_UpdateChecker->purchaseCode = $ascend_code;
}