...
class KT_WOO_EXTRAS_Taxonomy_Meta {
	...
	function show_field_file( $field, $meta ) {
		...
		echo "<a href='#' class='rwtm-file-upload button' data-field='{$field['id']}'>" . __( 'Select File', 'virtue' ) . "</a>";
		echo '</td>';
	}
	...
	function show_field_image( $field, $meta ) {
		...
		echo "<a href='#' class='rwtm-image-upload button' data-field='{$field['id']}'>" . __( 'Select Image', 'virtue' ) . "</a>";
		echo '</td>';
	}
